...
const Main = () => {
    ...
    const getItemsDataFromAPi = () => {
        axios.get(itemsDatabase)
            .then(res => setItems(res.data));
    }
    const getOffersDataFromAPi = () => {
        axios.get(offersDatabase)
    ...
    return(
        <Router>
            <Fragment>  
                {<Navbar uniqueCategory={uniqueCategory} cart={cart} setCart={setCart} order={order} setOrder={setOrder}/>}             
                <Routes>
                    <Route path="/" element={<Home items={items}/>}/>
                    <Route path="/shop/:category" element={<Shop items={items}/>}/>
                    <Route path="/shop" element={<Shop items={items}/>}/>
                    <Route path="/detail-item/:id" element={<DetailItem items={items} cart={cart} setCart={setCart} itemsDatabase={itemsDatabase} offers={offers}
                     uniqueCategory={uniqueCategory}  order={order} setOrder={setOrder}/>}/>
                    <Route path="/cart-detail" element={<CartDetail cart={cart} setCart={setCart} order={order} setOrder={setOrder}/>}/>
